...
import downloadData from './GreenProductDownload.json';
import pdf from '../../src/images1/download/PdfIcon.png';
import rar from '../../src/images1/download/rar.png';
import odt from '../../src/images1/download/odt.png';
...
function GreenProductDownload(props) {
        ...
        <>
            ...
            <div className="download">
                ...
                <div className={`product bigbanner mb-3`}>
                    <img className="relative" src={labelBanner} width="100%" height="100%" alt="環保產品下載專區" title="環保產品下載專區" />
                    ...
                    <div className="Button-wrapper">
                        ...
                        {/*  */}
                        {/*<a href={`${SSL}//${domainFormal}/MarkApply`} target="_blank" className="btn-link">*/}
                        ...
                        <Link to={`/categories/GreenProductDownload`} className="onfocus btn-link">
                    ...
                    {loading
                        ...
                        <>
                            <table className="table table-striped">
                                ...
                                <tbody>
                                    {downloadData.map((data, i) =>
                                        <tr key={i}>
                                            <td className="col-1">2121-12-09</td>
                                            <td className="col-5">{data.fileName}</td>
                                            <td className="col-2">{data.typeId}</td>
                                            <td className="col-2">{data.detailId}</td>
                                            <td className="col-2"><a href={data.link}><img src={data.extension === "PDF" && pdf || data.extension === "RAR" && rar || data.extension === "ODT" && odt} alt={data.fileName} title="檔案下載" className="pdf-img" /></a></td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
...
export default withRouter(GreenProductDownload);