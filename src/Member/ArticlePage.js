...
function ArticleInfo(props) {
            ...
            .then(res => {
                ...
                if (result.isSucess) {
                    ...
                    if (result.resultObject.videoPath) {
                        ...
                        console.log(result.resultObject.videoPath.substring(result.resultObject.videoPath.lastIndexOf('/') + 1))
    ...
    console.log(collector, fetchData.creator)
            ...
            fetch(`${SSL}//${domain}/api/api/MyGreen/Update`, {
                ...
                .then(res => {
                    ...
                    if (result.isSucess) {
                        ...
                        setShowDialog(true)
                        setAlertTitle("編輯成功")
                        history.push("/member/BookMarkShare?name=秀出你的綠&link=/daily/article&type=2")
                    }
                });
        }
    ...
    return (
        <>
            <div className="container-fluid mt-2 col-12 col-lg-8">
                    ...
                    <div className="green-article-page row">
                        <div className="col-sm-12 col-md-9 col-lg-9 media">
                            {!fetchData.videoPath
                                ...
                                :
                                <iframe className="video-wrapper-article-page" title={fetchData.content} src={`https://www.youtube.com/embed/${video}`}></iframe>
                            }
                        </div>
                            ...
                            <div className="d-flex article-func">
                                ...
                                {socialBtn &&
                                    <div className="arti-info-socailBtn">
                                        <SocialBtn myStyle="arti-info-shareBtn" collectTypeId={collectTypeId} handlePrint={handlePrint} hideHeart={true} title={"秀出你的綠"} url={`daily/article/info?${artiGuid}`} activityGuid={artiGuid} history={history} roleId="2" roleItemId="7" />
                                    </div>
                                }
                            </div>
