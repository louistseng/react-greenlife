        ...
        fetch(`${props.SSL}//${props.domain}/api/api/Manager/Participate/Edit`, {
            ...
            .then(res => {
                ...
                if (result.isSucess) {
                    ...
                    history.push('/member/office_management');
                }
            });
    }
                            ...
                            <ul className="final-list">
                                ...
                                <div className="final-select-wrapper">
                                    ...
                                    <div className="yes-no-wrapper">
                                        ...
                                        <input className="myCheckbox" disabled id="noforcity" name="city" type="radio" defaultChecked={!checkboxData.forEPA} /><label for="noforcity">否</label>
                                    </div>
                                </div>
                            </ul>
                        </div>
