...
function BlogProcess(props) {
    ...
    //點閱計數API
    useEffect(() => {
        clickRecord("45C51DE8-E25A-4DFC-B332-322C19FD9816", "19", collector)
    }, [collector]);
    ...
    useEffect(() => {
        window.scrollTo(0, 0)
        setLink()
        fetch(`${SSL}//${domain}/api/api/Manager/Blog/Record`, {
            method: 'POST',
            body: serialize({
                Guid: authGuid,
                Page: String(page),
    ...
    return (
        <>
            ...
            <div className="col-12 col-lg-8">
                <h3 className="green-title">網誌審核<i class="fas fa-chevron-circle-right" aria-hidden="true"></i>歷程</h3>
...
export default withRouter(BlogProcess);