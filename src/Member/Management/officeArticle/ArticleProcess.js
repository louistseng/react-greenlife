...
function ArticleProcess(props) {
    ...
    const memberToken = window.location.hostname.length > 10 ? greenlifeCookies.refreshToken : "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJleHAiOjE2MjgwMzkzNzgsIm5iZiI6MTYyODAzNzU3OCwiaXNzIjoiZ3JlZW5saWZlIiwiYXVkIjoiZ3JlZW5saWZlIiwic3ViIjoiYjdmNWI4YmItOWViYi00N2NhLTk2OTMtMTg0ZGI4Y2MwZTc3In0.rOHOm69Nr-1U7ADto2Y7RoPLU0m-lyGKPqUF-pEJFjj71t3fVwvlJ7uND4sCiWOneGu6VSw4OAk_yegr5Qfp0A";
    ...
    //點閱計數API
    useEffect(() => {
        clickRecord("8841FC73-BD65-4F82-B0CE-BB2C812B222C", "19", collector)
    }, [collector]);
    ...
    useEffect(() => {
        window.scrollTo(0, 0)
        setLink()
        fetch(`${SSL}//${domain}/api/api/Manager/OfficeArticle/Record`, {
            method: 'POST',
            body: serialize({
                Guid: authGuid,
                Page: String(page),
    ...
    return (
        <>
            ...
            <div className="col-12 col-lg-8">
                <h3 className="green-title">經驗分享文章審核<i class="fas fa-chevron-circle-right" aria-hidden="true"></i>歷程</h3>
...
export default withRouter(ArticleProcess);