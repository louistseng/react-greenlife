...
import { energyCheckboxes, waterCheckboxes, fuelCheckboxes, paperCheckboxes, reduceCheckboxes, trashCheckboxes, itemShopCheckboxes, plantCheckboxes, teachCheckboxes, finalCheckboxes } from '../office/checkboxes';
...
function Review(props) {
    ...
    useEffect(() => {
        window.scrollTo(0, 0)
        setLink()
        fetch(`${props.SSL}//${props.domain}/api/api/Manager/Participate/View`, {
            method: 'POST',
            body: serialize({
                Guid: authGuid
            }),
    ...
    }, [props.SSL, props.domain, collector, serialize]);
    ...
    const submit = async () => {
        ...
        fetch(`${props.SSL}//${props.domain}/api/api/Manager/Participate/Edit`, {
            method: 'POST',
            body: serialize({
                Guid: authGuid,
                            ...
                            <div className="final-banner">
                                <ul className="final-list">
                                    ...
                                    <div className="final-select-wrapper">
                                        ...
                                        <label className="checkbox-text  share-green-title" key="finalcheckBox3">3. 請問本次響應是否由縣市環保局協助輔導</label>
                                        <div className="yes-no-wrapper">
                                            <label for="yesforcity"></label>
                                            <input className="myCheckbox" disabled id="yesforcity" name="city" type="radio" defaultChecked={checkboxData.forEPA} /><label>是</label>
                                            <label for="city"></label>
                                            <input className="myCheckbox" disabled name="city" id="city" type="radio" defaultChecked={!checkboxData.forEPA} /><label>否</label>
                                        </div>
                                    </div>
                                </ul>
                            </div>
