...
import { useLockBodyScroll, checkLogin_and_redirect } from '../utils/Functions';
...
const Regular = React.lazy(() => import('../Components/GreenPoint/RegularPublic'));
            ...
            <div>
                ...
                <div className="green-point green-points">
                    <div className="welcome-section container">
                        <img src={mainTopPic} className="mainTopPic" alt="..." />
                        ...
                        <div className="secret-container" style={clickSecret ? { opacity: "1", transform: "scale(1)translate(50%, 0%)" } : { opacity: "0", transform: "scale(.2)translate(150%, 150%)" }}>
                            <div className="d-flex">
                                ...
                                <div className="img-container">
                                    <img onClick={() => setClickSecret(!clickSecret)} className="close" src={closeIcon} alt="..." />
                    ...
                    <div className="total-count-section row container">
                        ...
                        <div className="col-4 grey-text">
                            <div className="rounded-card">
                                <h5>綠活島紀事</h5>
                                <h6>{activityReport.likeCount}個讚 {activityReport.myGreenCount}則照片/影片 {activityReport.blogCount}16則網誌</h6>
                            </div>
                            <div className="rounded-card">
                                <h5>島民綠行動</h5>
                        ...
                        <div className="instruction-content">
                            ...
                            {typeId === "2" &&
                                <div className="mission-card-wrapper">
                                    <div onClick={() => setMissionType("1")} className="mission-card">
                                        <div className="img-container">
                                            <img className="background" src={bgWorld} />
                                            <img className="character" src={missionCard_bear} />
                                        </div>
                                        <div className="btn-wrapper"><button className="mission-btn">主題任務</button></div>
                                    </div>
                                    <div onClick={() => setMissionType("2")} className="mission-card">
                                        <div className="img-container">
                                            <img className="background" src={bgCity} alt="..." />
                                            <img className="character" src={missionCard_greenMan} alt="..." />
                                        </div>
                            ...
                            {typeId === "2" && missionType === "1" &&
                                <div className="theme-mission container">
                                    ...
                                    <div className="theme-content">
                                        <div className="d-flex"><h6>9月活動｜<span style={{ color: "red" }}>居家</span>BINGO 綠活GO</h6><h6 className="date-container">2021/9/13~2021/9/30</h6></div>
                                        <div className="d-flex row">
                                            <div className="grey-bg row col-9">
                                                <div className="card-left col-7">
                                                    <h6>生活環保學堂上線啦！</h6>
                                                    <h6>減碳雙熊帶你認識居家節能小妙招</h6>
                                                    <div className="d-flex">
                                                        <h6 className="number-block">1</h6>
                                                        <h6>進入<Link>主題認識活動頁面</Link></h6>
                                                    </div>
                                                    <div className="d-flex">
                        ...
                        <div className="ending-section row ">
                            <div className="ending-section-wrapper-background">
                                <div className="img-text-wrapper container">
                                    <img src={partners} className="col-6" alt="..." />
                                    <div className="col-6">
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-5 col-md-6 col-sm-12">
                                <ul className="social">
                                    <li>更新日期: <font>{siteInfo.item9}</font></li>
                                    {/* <li>瀏覽人次: <font>{visitedCount}</font></li> */}
                                </ul>
                            </div>
                        </div>
                    </div>
